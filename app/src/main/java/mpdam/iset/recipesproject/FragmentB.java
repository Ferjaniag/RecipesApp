...
public class FragmentB extends Fragment implements SensorEventListener {
    ...
    TextView frameTitleB,recipeTitle,recipeDescription;
    Button prepareButton ;
    CardView recipeCard;

    private RecyclerView recipeList;
    private RecipeAdapter adapter;
    String url="https://api.edamam.com/search?q=healthy food&app_id=dd36f90c&app_key=0146a33d993f5593b28c0ba17ac3e449" ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      View  view= inflater.inflate(R.layout.fragment_b, container, false);
        frameLayoutB = view.findViewById(R.id.frameLayoutB) ;
        // Initialize views after inflating the layout
        recipeList = view.findViewById(R.id.recipe_list);  // Use view.findViewById here
        frameLayoutB = view.findViewById(R.id.frameLayoutB) ;
        frameTitleB = view.findViewById(R.id.frameTitleB) ;
        ...
        Log.i("fragment b","im herrree !!!!!!!!!") ;

// Charger animation de fade-in à partir du fichier XML
        Animation fadeInAnimation = AnimationUtils.loadAnimation(getActivity(), R.anim.fade_in_cardview);

// Démarrer animation de fade-in pour le CardView
        recipeCard.startAnimation(fadeInAnimation);
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (event.sensor.getType() == Sensor.TYPE_LIGHT) {
            ...
            if (lightValue < LOW_LIGHT_THRESHOLD) {
                    ...
                    frameLayoutB.setBackgroundColor(requireContext().getResources().getColor(R.color.green_light));
                    frameTitleB.setTextColor(requireContext().getResources().getColor(R.color.green));
                    ...
                    frameTitleB.setTextColor(requireContext().getResources().getColor(R.color.green_LightHight));
                    frameLayoutB.setBackgroundColor(requireContext().getResources().getColor(R.color.green_light_LightHigh));
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        // For example, update views with translated text
        updateViews(newConfig);
    }

    private void updateViews(Configuration nc) {
        // Update text views, buttons, etc. with translated text
        Locale newLocale = nc.locale;

        Log.i("config local","local:"+newLocale) ;
        frameTitleB.setText(getString(R.string.fragment_title_hf));
    }
